...
//! `cargo run --release --features=cuda-single --example fee_cuda -- 1000000 mwa_full_embedded_element_pattern.h5`
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let iau_order = true;
    let jones = cuda_beam.calc_jones(&azels, array_latitude_rad, iau_order)?;
